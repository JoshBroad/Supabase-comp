...
- **📂 Multi-Format Ingestion**: Upload `CSV`, `JSON`, `XML`, and unstructured `TXT` files directly.
- **🧠 AI-Powered ETL**:
...
- **⚡ Autonomous Agent**: Uses **LangGraph** to orchestrate a multi-step pipeline:
...
- **🛡️ Data Drift Detection**: Alerts users when new data doesn't fit the existing schema.
